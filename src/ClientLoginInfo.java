...
public class ClientLoginInfo extends JFrame {
	...
	public void ClientLoginInfoModel(JPanel panel,int num) {
		...
		dbId = new JLabel(getDTO.getId());// db로부터아이디
		...
		dbamountOfMoney = new JLabel(String.valueOf(getDTO.getMountOfMoney() + "원"));
		...
		dbRemainTime = new JLabel(String.valueOf(getDTO.getRemainTime() + "분"));
